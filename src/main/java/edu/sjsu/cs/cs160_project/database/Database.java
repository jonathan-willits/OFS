...
public class Database {
    ...
    public void create_tables() {
        ...
        String initOrder = "CREATE TABLE IF NOT EXISTS order(id integer PRIMARY KEY, customer_id integer NOT NULL, tot_price REAL NOT NULL, tot_weight REAL NOT NULL, address_id integer NOT NULL)";

        // String to create table for address data
        String initAddress = "CREATE TABLE IF NOT EXISTS address(id integer PRIMARY KEY, customer_id integer NOT NULL, location text NOT NULL)";
